<div class="col-md-4">
    <div class="tab-block-left nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <a class="tab-link nav-link" id="v-pills-create-post-tab" data-toggle="pill" href="#v-pills-create-post" role="tab" aria-controls="v-pills-home" aria-selected="false">Создать пост</a>
    </div>
</div>
<div class="col-md-8">
